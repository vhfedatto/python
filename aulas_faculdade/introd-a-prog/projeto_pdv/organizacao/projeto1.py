...
#Criando o Carrinho de Compras:
    #Fazer um laço de repetição para o cliente escolher quais produtos ele quer.
    #Programa verifica quantos do produto tem em estoque.
carrinho = {}
relatorio_vendas = []
...
#adicionar, na parte de pagamento, para o cliente inserir os dados referente ao pagamento (como cartão etc.) junto com uma sessão de cupons para serem digitados. Se o usuário colocar um cupom válido, o valor receberá um desconto.

#escolha se quer que entregue na sua casa - digitar a região. Cada região do Brasil possui um valor de frete diferente. indicar somente ficcionalmente o cep (não irá interferir em nada) - se for pegar na loja, não precisa adicionar o valor do frete.
